/* GF2 Rev. A Configuration Program - Version 1.0 for Debian Linux
...
int main(int argc, char **argv)
{
    ...
    {
        fprintf(stderr, "Error: Missing argument.\nUsage: gf2-ra-conf SERIALNUMBER\n");
...
{
    unsigned char control_buf_out[64] = {
        0x1C, 0x03, 0x47, 0x00, 0x46, 0x00, 0x32, 0x00,  // GF2-A0xxxxxx
...
void write_usb_cfg(libusb_device_handle *devhandle)  // Writes the USB configuration values into the OTP ROM
{
    unsigned char control_buf_out[10] = {
        ...
        0x7D,        // Maximum power is 250mA (0x7D)
